...
def getData1(nset=1, nenv=1):
    ...
    if nset==1:
        ...
        if getEnvInfo(nenv,"red") in [0] or (getEnvInfo(nenv,"red") in [3] and getEnvInfo(nenv,"blue") in [0]): # rt or rbt 
        ...
        if getEnvInfo(nenv,"red") in [0] or (getEnvInfo(nenv,"red") in [2] and getEnvInfo(nenv,"green") in [0]): # rt or rgt 
        ...
        if getEnvInfo(nenv,"green") in [0] or (getEnvInfo(nenv,"green") in [3] and getEnvInfo(nenv,"blue") in [0]): # gt or gbt 
        ...
        if getEnvInfo(nenv,"green") in [0] or (getEnvInfo(nenv,"green") in [1] and getEnvInfo(nenv,"red") in [0]): # gt or grt 
        ...
        if getEnvInfo(nenv,"blue") in [0] or (getEnvInfo(nenv,"blue") in [2] and getEnvInfo(nenv,"green") in [0]): # bt or bgt 
            solutions=["(grasp pr2R green) (place pr2R blue red)",
        ...
        if getEnvInfo(nenv,"blue") in [0] or (getEnvInfo(nenv,"blue") in [1] and getEnvInfo(nenv,"red") in [0]): # bt or brt 
            solutions=["(grasp pr2R green) (place pr2R blue green)",
                        "(grasp pr2L blue) (place pr2L blue green)"]
            numLoops=1*2*2
        
        elif getEnvInfo(nenv,"green") in [3] or (getEnvInfo(nenv,"blue") in [1] and getEnvInfo(nenv,"red") in [3]): # gb or grb
...
def getData(nset=1, nenv=1):
    ...
    if nset==1:
        ...
        if getEnvInfo(nenv,"red") in [1,2,3] and getEnvInfo(nenv,"green") in [1,2,3]:
            ...
            numLoops=2*2*2
        elif getEnvInfo(nenv,"red") in [0] and getEnvInfo(nenv,"green") in [0]:
            solutions=[]
            numLoops=0
            ...
            if getEnvInfo(nenv,"red") in [1,3] and getEnvInfo(nenv,"green") in [0,2,3]:
                solutions=["(grasp pr2R red) (grasp pr2L green) (place pr2R red table1) (place pr2L green red)",
                            "(grasp pr2R red) (grasp pr2L green) (place pr2L green red) (place pr2R red table1)",
                            "(grasp pr2R red) (place pr2R red table1) (grasp pr2R green) (place pr2R green red)", 
                            "(grasp pr2R red) (place pr2R red table1) (grasp pr2L green) (place pr2L green red)", 
            ...
            elif getEnvInfo(nenv,"red") in [0] and getEnvInfo(nenv,"green") in [1]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"blue") in [1] and getEnvInfo(nenv,"red") in [2]: # brg
                solutions=["(grasp pr2R green) (grasp pr2L blue) (place pr2R green blue) (place pr2L blue table1) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2R green) (grasp pr2L blue) (place pr2L blue table1) (place pr2R green blue) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2R blue) (grasp pr2L green) (place pr2R blue table1) (place pr2L green blue) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2R blue) (grasp pr2L green) (place pr2L green blue) (place pr2R blue table1) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2R blue) (place pr2R blue table1) (grasp pr2R green) (place pr2R green blue) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2R blue) (place pr2R blue table1) (grasp pr2L green) (place pr2L green blue) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2L green) (grasp pr2R blue) (place pr2L green blue) (place pr2R blue table1) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2L green) (grasp pr2R blue) (place pr2R blue table1) (place pr2L green blue) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2L blue) (grasp pr2R green) (place pr2L blue table1) (place pr2R green blue) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2L blue) (grasp pr2R green) (place pr2R green blue) (place pr2L blue table1) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2L blue) (place pr2L blue table1) (grasp pr2R green) (place pr2R green blue) (grasp pr2R red) (place pr2R green red)",
                            "(grasp pr2L blue) (place pr2L blue table1) (grasp pr2L green) (place pr2L green blue) (grasp pr2R red) (place pr2R green red)",
            ...
            elif getEnvInfo(nenv,"red") in [0] and getEnvInfo(nenv,"green") in [3]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"red") in [1,2,3] and getEnvInfo(nenv,"blue") in [1,2,3]:
                ...
                numLoops=2*2*2
            elif getEnvInfo(nenv,"red") in [0] and getEnvInfo(nenv,"blue") in [0]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"red") in [1,2] and getEnvInfo(nenv,"blue") in [0,2,3]:
                solutions=["(grasp pr2R red) (grasp pr2L blue) (place pr2R red table1) (place pr2L blue red)",
                            "(grasp pr2R red) (grasp pr2L blue) (place pr2L blue red) (place pr2R red table1)",
                            "(grasp pr2R red) (place pr2R red table1) (grasp pr2R blue) (place pr2R blue red)", 
                            "(grasp pr2R red) (place pr2R red table1) (grasp pr2L blue) (place pr2L blue red)", 
            ...
            elif getEnvInfo(nenv,"red") in [0] and getEnvInfo(nenv,"blue") in [1]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"green") in [1] and getEnvInfo(nenv,"red") in [3]: # grb
                solutions=["(grasp pr2R blue) (grasp pr2L green) (place pr2R blue green) (place pr2L green table1) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2R blue) (grasp pr2L green) (place pr2L green table1) (place pr2R blue green) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2R green) (grasp pr2L blue) (place pr2R green table1) (place pr2L blue green) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2R green) (grasp pr2L blue) (place pr2L blue green) (place pr2R green table1) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2R green) (place pr2R green table1) (grasp pr2R blue) (place pr2R blue green) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2R green) (place pr2R green table1) (grasp pr2L blue) (place pr2L blue green) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2L blue) (grasp pr2R green) (place pr2L blue green) (place pr2R green table1) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2L blue) (grasp pr2R green) (place pr2R green table1) (place pr2L blue green) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2L green) (grasp pr2R blue) (place pr2L green table1) (place pr2R blue green) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2L green) (grasp pr2R blue) (place pr2R blue green) (place pr2L green table1) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2L green) (place pr2L green table1) (grasp pr2R blue) (place pr2R blue green) (grasp pr2R red) (place pr2R blue red)",
                            "(grasp pr2L green) (place pr2L green table1) (grasp pr2L blue) (place pr2L blue green) (grasp pr2R red) (place pr2R blue red)",
            ...
            elif getEnvInfo(nenv,"red") in [0] and getEnvInfo(nenv,"blue") in [2]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"green") in [2,3] and getEnvInfo(nenv,"red") in [0,1,3]:
                solutions=["(grasp pr2R green) (grasp pr2L red) (place pr2R green table1) (place pr2L red green)",
                            "(grasp pr2R green) (grasp pr2L red) (place pr2L red green) (place pr2R green table1)",
                            "(grasp pr2R green) (place pr2R green table1) (grasp pr2R red) (place pr2R red green)", 
                            "(grasp pr2R green) (place pr2R green table1) (grasp pr2L red) (place pr2L red green)", 
            ...
            elif getEnvInfo(nenv,"green") in [0] and getEnvInfo(nenv,"red") in [2]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"blue") in [2] or getEnvInfo(nenv,"blue") in [1] and getEnvInfo(nenv,"green") in [0,1,2] and getEnvInfo(nenv,"red") in [0,1]:
            ...
            if getEnvInfo(nenv,"green") in [3] and getEnvInfo(nenv,"blue") in [1]: # gbr
                solutions=["(grasp pr2R red) (grasp pr2L green) (place pr2R red green) (place pr2L green table1) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2R red) (grasp pr2L green) (place pr2L green table1) (place pr2R red green) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2R green) (grasp pr2L red) (place pr2R green table1) (place pr2L red green) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2R green) (grasp pr2L red) (place pr2L red green) (place pr2R green table1) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2R green) (place pr2R green table1) (grasp pr2R red) (place pr2R red green) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2R green) (place pr2R green table1) (grasp pr2L red) (place pr2L red green) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2L red) (grasp pr2R green) (place pr2L red green) (place pr2R green table1) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2L red) (grasp pr2R green) (place pr2R green table1) (place pr2L red green) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2L green) (grasp pr2R red) (place pr2L green table1) (place pr2R red green) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2L green) (grasp pr2R red) (place pr2R red green) (place pr2L green table1) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2L green) (place pr2L green table1) (grasp pr2R red) (place pr2R red green) (grasp pr2R blue) (place pr2R red blue)",
                            "(grasp pr2L green) (place pr2L green table1) (grasp pr2L red) (place pr2L red green) (grasp pr2R blue) (place pr2R red blue)",
            ...
            elif getEnvInfo(nenv,"blue") in [0] and getEnvInfo(nenv,"red") in [2]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"green") in [1] or getEnvInfo(nenv,"green") in [2] and getEnvInfo(nenv,"red") in [0,1,3] and getEnvInfo(nenv,"blue") in [0,3]:
            ...
            if getEnvInfo(nenv,"blue") in [2] and getEnvInfo(nenv,"green") in [1]: # bgr
                solutions=["(grasp pr2R red) (grasp pr2L blue) (place pr2R red blue) (place pr2L blue table1) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2R red) (grasp pr2L blue) (place pr2L blue table1) (place pr2R red blue) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2R blue) (grasp pr2L red) (place pr2R blue table1) (place pr2L red blue) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2R blue) (grasp pr2L red) (place pr2L red blue) (place pr2R blue table1) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2R blue) (place pr2R blue table1) (grasp pr2R red) (place pr2R red blue) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2R blue) (place pr2R blue table1) (grasp pr2L red) (place pr2L red blue) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2L red) (grasp pr2R blue) (place pr2L red blue) (place pr2R blue table1) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2L red) (grasp pr2R blue) (place pr2R blue table1) (place pr2L red blue) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2L blue) (grasp pr2R red) (place pr2L blue table1) (place pr2R red blue) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2L blue) (grasp pr2R red) (place pr2R red blue) (place pr2L blue table1) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2L blue) (place pr2L blue table1) (grasp pr2R red) (place pr2R red blue) (grasp pr2R green) (place pr2R red green)",
                            "(grasp pr2L blue) (place pr2L blue table1) (grasp pr2L red) (place pr2L red blue) (grasp pr2R green) (place pr2R red green)",
            ...
            elif getEnvInfo(nenv,"green") in [0] and getEnvInfo(nenv,"red") in [3]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"blue") in [1] or getEnvInfo(nenv,"blue") in [2] and getEnvInfo(nenv,"red") in [0,1,2] and getEnvInfo(nenv,"green") in [0,2]:
            ...
            if getEnvInfo(nenv,"blue") in [2,3] and getEnvInfo(nenv,"red") in [0,1,2]:
                solutions=["(grasp pr2R blue) (grasp pr2L red) (place pr2R blue table1) (place pr2L red blue)",
                            "(grasp pr2R blue) (grasp pr2L red) (place pr2L red blue) (place pr2R blue table1)",
                            "(grasp pr2R blue) (place pr2R blue table1) (grasp pr2R red) (place pr2R red blue)", 
                            "(grasp pr2R blue) (place pr2R blue table1) (grasp pr2L red) (place pr2L red blue)", 
            ...
            elif getEnvInfo(nenv,"blue") in [0] and getEnvInfo(nenv,"red") in [3]:
                solutions=[]
                numLoops=0

        elif nset==28:
            goalString=["(on red blue) (on blue green)", "(on blue green) (on red blue)"]
            if getEnvInfo(nenv,"green") in [3] or getEnvInfo(nenv,"green") in [1] and getEnvInfo(nenv,"blue") in [0,1,3] and getEnvInfo(nenv,"red") in [0,1]:
            ...
            if getEnvInfo(nenv,"blue") in [1,2,3] and getEnvInfo(nenv,"green") in [1,2,3]:
                ...
                solutions=["(grasp pr2L green) (place pr2L green table1)",
                        "(grasp pr2R green) (place pr2R green table1)"]
                numLoops=2*2*2
            elif getEnvInfo(nenv,"blue") in [0] and getEnvInfo(nenv,"green") in [0]:
                solutions=[]
                numLoops=0

        elif nset==34:
            goalString=["(on green table1) (on blue red)", "(on blue red) (on green table1)"]
            if getEnvInfo(nenv,"red") in [2] and getEnvInfo(nenv,"green") in [3]: # rgb
                solutions=["(grasp pr2R blue) (grasp pr2L red) (place pr2R blue red) (place pr2L red table1) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2R blue) (grasp pr2L red) (place pr2L red table1) (place pr2R blue red) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2R red) (grasp pr2L blue) (place pr2R red table1) (place pr2L blue red) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2R red) (grasp pr2L blue) (place pr2L blue red) (place pr2R red table1) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2R red) (place pr2R red table1) (grasp pr2R blue) (place pr2R blue red) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2R red) (place pr2R red table1) (grasp pr2L blue) (place pr2L blue red) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2L blue) (grasp pr2R red) (place pr2L blue red) (place pr2R red table1) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2L blue) (grasp pr2R red) (place pr2R red table1) (place pr2L blue red) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2L red) (grasp pr2R blue) (place pr2L red table1) (place pr2R blue red) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2L red) (grasp pr2R blue) (place pr2R blue red) (place pr2L red table1) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2L red) (place pr2L red table1) (grasp pr2R blue) (place pr2R blue red) (grasp pr2R green) (place pr2R blue green)",
                            "(grasp pr2L red) (place pr2L red table1) (grasp pr2L blue) (place pr2L blue red) (grasp pr2R green) (place pr2R blue green)",
            ...
            elif getEnvInfo(nenv,"green") in [0] and getEnvInfo(nenv,"blue") in [1]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"green") in [1,2] and getEnvInfo(nenv,"blue") in [0,1,3]:
                solutions=["(grasp pr2R green) (grasp pr2L blue) (place pr2R green table1) (place pr2L blue green)",
                            "(grasp pr2R green) (grasp pr2L blue) (place pr2L blue green) (place pr2R green table1)",
                            "(grasp pr2R green) (place pr2R green table1) (grasp pr2R blue) (place pr2R blue green)", 
                            "(grasp pr2R green) (place pr2R green table1) (grasp pr2L blue) (place pr2L blue green)", 
            ...
            elif getEnvInfo(nenv,"green") in [0] and getEnvInfo(nenv,"blue") in [2]:
                solutions=[]
                numLoops=0
            ...
            if getEnvInfo(nenv,"red") in [3] and getEnvInfo(nenv,"blue") in [2]: # rbg
                solutions=["(grasp pr2R green) (grasp pr2L red) (place pr2R green red) (place pr2L red table1) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2R green) (grasp pr2L red) (place pr2L red table1) (place pr2R green red) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2R red) (grasp pr2L green) (place pr2R red table1) (place pr2L green red) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2R red) (grasp pr2L green) (place pr2L green red) (place pr2R red table1) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2R red) (place pr2R red table1) (grasp pr2R green) (place pr2R green red) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2R red) (place pr2R red table1) (grasp pr2L green) (place pr2L green red) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2L green) (grasp pr2R red) (place pr2L green red) (place pr2R red table1) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2L green) (grasp pr2R red) (place pr2R red table1) (place pr2L green red) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2L red) (grasp pr2R green) (place pr2L red table1) (place pr2R green red) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2L red) (grasp pr2R green) (place pr2R green red) (place pr2L red table1) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2L red) (place pr2L red table1) (grasp pr2R green) (place pr2R green red) (grasp pr2R blue) (place pr2R green blue)",
                            "(grasp pr2L red) (place pr2L red table1) (grasp pr2L green) (place pr2L green red) (grasp pr2R blue) (place pr2R green blue)",
            ...
            elif getEnvInfo(nenv,"green") in [2] and getEnvInfo(nenv,"blue") in [1,2,3]:
                solutions=["(grasp pr2R blue) (place pr2R blue table1)",
                            "(grasp pr2L blue) (place pr2L blue table1)"]
                numLoops=2*2*2

            elif getEnvInfo(nenv,"blue") in [0] and getEnvInfo(nenv,"green") in [2]:
                solutions=[]
                numLoops=0
            ...
            # b r
            if getEnvInfo(nenv,"red") in [2] or getEnvInfo(nenv,"red") in [3] and getEnvInfo(nenv,"green") in [0,2,3] and getEnvInfo(nenv,"blue") in [0,3]:
            ...
            if getEnvInfo(nenv,"blue") in [1,3] and getEnvInfo(nenv,"green") in [0,1,2]:
                solutions=["(grasp pr2R blue) (grasp pr2L green) (place pr2R blue table1) (place pr2L green blue)",
                            "(grasp pr2R blue) (grasp pr2L green) (place pr2L green blue) (place pr2R blue table1)",
                            "(grasp pr2R blue) (place pr2R blue table1) (grasp pr2R green) (place pr2R green blue)", 
                            "(grasp pr2R blue) (place pr2R blue table1) (grasp pr2L green) (place pr2L green blue)", 
            ...
            elif getEnvInfo(nenv,"blue") in [0] and getEnvInfo(nenv,"green") in [3]:
                solutions=[]
                numLoops=0
            ...
            # 1 2
            if getEnvInfo(nenv,"red") in [3] or getEnvInfo(nenv,"red") in [2] and getEnvInfo(nenv,"blue") in [0,2,3] and getEnvInfo(nenv,"green") in [0,2]:
