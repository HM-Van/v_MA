...
joint joint0(table1 red){type=rigid, Q:<t(-0.2 0.2 .15)>}
joint joint1 (table1 green) {type=rigid, Q:<t(0.2 -0.3 .15)>}
joint joint2(green blue) {joint:rigid, Q:<t(0.01 -.05 .15)>}
