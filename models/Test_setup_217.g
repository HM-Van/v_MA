...
joint joint0(table1 red){type=rigid, Q:<t(0.1 0.4 .15)>}
joint joint1 (blue green) {type=rigid, Q:<t(-0.03 -0.055 .15)>}
joint joint2(table1 blue) {joint:rigid, Q:<t(-0.1 -.55 .15)>}
