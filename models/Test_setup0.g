...
Frame table1{ shape:ssBox, X=<T t(-0.4 1.1 .5) d(90 0 0 1)>, size=[.8 2.6 .1 .02], color=[.3 .3 .3] fixed, contact, logical={ table } }

#Frame table2{ shape:ssBox, X=<T t(.8 0 .6)>, size=[.8 1.4 .1 .02], color=[.3 .3 .3] fixed, contact, logical={ table } }
Frame table2{ shape:ssBox, X=<T t(.8 -0.5 .5)>, size=[.8 0.8 .1 .02], color=[.3 .3 .3] fixed, contact, logical={ table } }
