...
joint joint0(blue red){type=rigid, Q:<t(-0.025 -0.05 .15)>}
joint joint1 (table1 green) {type=rigid, Q:<t(0.15 0.05 .15)>}
joint joint2(table1 blue) {joint:rigid, Q:<t(-0.2 .45 .15)>}
