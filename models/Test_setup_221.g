...
joint joint0(green red){type=rigid, Q:<t(0.04 0.04 .15)>}
joint joint1 (table1 green) {type=rigid, Q:<t(-0.2 -0.5 .15)>}
joint joint2(table1 blue) {joint:rigid, Q:<t(-0.1 .25 .15)>}
